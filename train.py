...
def build_parser():
    ...
    parser.add_argument('--source', default="mnist", choices=['mnist', 'svhn'], help="Source Dataset. Choose mnist or svhn")
    parser.add_argument('--target', default="svhn", choices=['mnist', 'svhn'], help="Target Dataset. Choose mnist or svhn")
